...
import webservis.webservisc.exceptions.NonexistentEntityException;
import webservis.webservisc.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("webservis_webservisc_jar_0.0.1-SNAPSHOTPU");
